...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      {/* Footer */}
      <footer className="py-12 px-6 md:px-12 bg-gray-900 text-gray-400">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div className="mb-6 md:mb-0">
              <h3 className="text-2xl font-bold text-white mb-2">Company</h3>
              <p className="max-w-xs">Creating healthcare technology that empowers people and organizations since 2018.</p>
            </div>
