...
//                   <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">{hospital.name}</h2>
//                   <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
//                     hospital.category === 'Public' ? 'bg-green-100 text-green-800' : 'bg-purple-100 text-purple-800'
//                   }`}>
//                     {hospital.category}
//                   </span>
//                 </div>
...
//                     </svg>
//                     <span className="ml-1 text-gray-700">{hospital.rating} <span className="text-gray-500">/5</span></span>
//                   </div>
...
//                     <p className="text-2xl font-bold text-gray-900">${hospital.price}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                 </svg>
//                 <p className="mt-2 text-gray-500">Map of {hospital.name}</p>
