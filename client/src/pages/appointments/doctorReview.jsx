...
const AppointmentsAndReview = () => {
  ...
  const handleReviewSubmit = async (e) => {
    ...
    if (!selectedDoctor || !review || rating === 0) {
      setError('Please select a doctor, write a review, and provide a rating.');
      return;
    }
  ...
  // Function to get unique doctors from appointments
  const getUniqueDoctors = () => {
    const doctorMap = {};
    appointments.forEach(appointment => {
      if (!doctorMap[appointment.doctor._id]) {
        doctorMap[appointment.doctor._id] = appointment.doctor;
      }
    });
        ...
        <div className="max-w-xl mx-auto">
          <div className="text-center mb-6">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Manage appointments and share your experience
            </p>
          </div>
          ...
          {/* Mobile Quick Doctor Select */}
          <div className="bg-white rounded-lg shadow-md mb-4 p-4">
            <h2 className="text-lg font-medium text-gray-800 mb-3">Select a Doctor to Review</h2>
          ...
          <div id="review-section" className="bg-white rounded-lg shadow-md mb-4">
            <div className="px-4 py-3 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-800">
                {selectedDoctor ? `Review Dr. ${selectedDoctor.name}` : 'Add Your Review'}
              </h2>
            </div>

            {!selectedDoctor ? (
              <div className="p-4 text-center">
                <p className="text-gray-500 text-sm">Select a doctor above to leave a review</p>
              </div>
            ) : submitSuccess ? (
              <div className="p-4 text-center">
          ...
          <div className="bg-white rounded-lg shadow-md">
            <div className="px-4 py-3 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-800">Your Appointments</h2>
            </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 flex-1">
                        <div className="flex items-center justify-between">
                          <h3 className="text-sm font-medium text-gray-900">Dr. {appointment.doctor.name}</h3>
                          <button
                            onClick={() => handleDoctorSelect(appointment.doctor)}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            Manage your appointments and share your experience with our healthcare professionals
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800">Your Past Appointments</h2>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="sticky top-8">
                ...
                {!selectedDoctor ? (
                  <div className="p-6">
                    <div className="text-center py-8">
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        Select a doctor from your appointments to leave a review.
                      </p>
                    </div>

                    <div className="mt-4">
                      <h3 className="text-sm font-medium text-gray-900">Your Doctors</h3>
                  ...
                  <div className="p-6">
                    <div className="text-center py-8">
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Thank you for sharing your experience with Dr. {selectedDoctor.name}.
                      </p>
                      <div className="mt-6">
                        <button
                          onClick={() => setSelectedDoctor(null)}
              ...
              {selectedDoctor && !submitSuccess && (
                <div className="mt-6 bg-white rounded-lg shadow overflow-hidden">
                  <div className="px-6 py-4 border-b border-gray-200">
                    <h3 className="text-lg font-medium text-gray-900">Review Tips</h3>
                  </div>
                  <div className="p-6">
                    <ul className="space-y-2 text-sm text-gray-600 list-disc pl-5">
                      <li>Share specific details about your experience</li>
                      <li>Mention the doctor&apos;s communication style</li>
                      <li>Was the wait time reasonable?</li>
                      <li>Did the doctor listen to your concerns?</li>
                      <li>Would you recommend this doctor to others?</li>
                    </ul>
                  </div>
                </div>
              )}
...
export default AppointmentsAndReview;