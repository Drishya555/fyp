...
import DoctorReview from "./doctorReview.jsx";
import HospitalReview from "./hospitalreview.jsx";


const menuItems = [
  { id: 1, name: "Doctor Review", icon: <LayoutDashboard size={20} />, component: <DoctorReview /> },
  { id: 2, name: "Hospital Review", icon: <CalendarClock size={20} />, component: <HospitalReview /> },
];
